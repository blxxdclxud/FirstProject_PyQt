...
"color: white;")
        ...
        self.gridLayout_3.addWidget(self.password_error_text, 3, 0, 1, 1)
...
"}")
        ...
        self.gridLayout_3.addWidget(self.sign_in_button, 4, 0, 1, 1)
...
"}")
        ...
        self.gridLayout_3.addWidget(self.sign_up_button, 5, 0, 1, 1)
...
"}")
        ...
        self.show_new_password_btn = QtWidgets.QCheckBox(self.sign_up_widget)
        self.show_new_password_btn.setStyleSheet("QCheckBox:indicator:checked{    \n"
"    image: url(./icons/visibility.png);\n"
"}\n"
"QCheckBox:indicator:unchecked{    \n"
"    image: url(./icons/visibility (1).png);\n"
"}")
        self.show_new_password_btn.setText("")
        self.show_new_password_btn.setObjectName("show_new_password_btn")
        self.gridLayout_5.addWidget(self.show_new_password_btn, 4, 1, 1, 1)
        self.show_repeated_password_btn = QtWidgets.QCheckBox(self.sign_up_widget)
        self.show_repeated_password_btn.setStyleSheet("QCheckBox:indicator:checked{    \n"
"    image: url(./icons/visibility.png);\n"
"}\n"
"QCheckBox:indicator:unchecked{    \n"
"    image: url(./icons/visibility (1).png);\n"
"}")
        self.show_repeated_password_btn.setText("")
        self.show_repeated_password_btn.setObjectName("show_repeated_password_btn")
        self.gridLayout_5.addWidget(self.show_repeated_password_btn, 6, 1, 1, 1)
